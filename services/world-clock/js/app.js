...
(function tool() {
  ...
  var CITIES = [
    { tz: "UTC", name: "UTC (GMT)", alias: "utc gmt greenwich zulu universal coordinated time 협정세계시 그리니치" },
    ...
    { tz: "America/Phoenix", name: "Phoenix", alias: "phoenix arizona usa 피닉스 애리조나" },
    { tz: "America/Toronto", name: "Toronto", alias: "toronto canada 토론토 캐나다" },
    { tz: "America/Vancouver", name: "Vancouver", alias: "vancouver canada 밴쿠버 캐나다" },
    { tz: "America/Bogota", name: "Bogota", alias: "bogota colombia 보고타 콜롬비아" },
    { tz: "America/Lima", name: "Lima", alias: "lima peru 리마 페루" },
    { tz: "America/Santiago", name: "Santiago", alias: "santiago chile 산티아고 칠레" },
    ...
    { tz: "Europe/Dublin", name: "Dublin", alias: "dublin ireland 더블린 아일랜드" },
    { tz: "Europe/Lisbon", name: "Lisbon", alias: "lisbon portugal 리스본 포르투갈" },
    { tz: "Europe/Paris", name: "Paris", alias: "paris france 파리 프랑스" },
    { tz: "Europe/Brussels", name: "Brussels", alias: "brussels belgium 브뤼셀 벨기에" },
    { tz: "Europe/Zurich", name: "Zurich", alias: "zurich geneva switzerland 취리히 제네바 스위스" },
    { tz: "Europe/Vienna", name: "Vienna", alias: "vienna austria 빈 비엔나 오스트리아" },
    { tz: "Europe/Stockholm", name: "Stockholm", alias: "stockholm sweden 스톡홀름 스웨덴" },
    { tz: "Europe/Oslo", name: "Oslo", alias: "oslo norway 오슬로 노르웨이" },
    { tz: "Europe/Copenhagen", name: "Copenhagen", alias: "copenhagen denmark 코펜하겐 덴마크" },
    { tz: "Europe/Helsinki", name: "Helsinki", alias: "helsinki finland 헬싱키 핀란드" },
    { tz: "Europe/Warsaw", name: "Warsaw", alias: "warsaw poland 바르샤바 폴란드" },
    { tz: "Europe/Athens", name: "Athens", alias: "athens greece 아테네 그리스" },
    { tz: "Europe/Kyiv", name: "Kyiv", alias: "kyiv kiev ukraine 키이우 키예프 우크라이나" },
    ...
    { tz: "Asia/Jerusalem", name: "Tel Aviv", alias: "tel aviv jerusalem israel 텔아비브 예루살렘 이스라엘" },
    ...
    { tz: "Asia/Colombo", name: "Colombo", alias: "colombo sri lanka 콜롬보 스리랑카" },
    { tz: "Asia/Bangkok", name: "Bangkok", alias: "bangkok thailand 방콕 태국" },
    { tz: "Asia/Jakarta", name: "Jakarta", alias: "jakarta indonesia 자카르타 인도네시아" },
    { tz: "Asia/Ho_Chi_Minh", name: "Ho Chi Minh City", alias: "ho chi minh saigon hanoi vietnam 호치민 하노이 베트남" },
    { tz: "Asia/Kuala_Lumpur", name: "Kuala Lumpur", alias: "kuala lumpur malaysia 쿠알라룸푸르 말레이시아" },
    { tz: "Asia/Singapore", name: "Singapore", alias: "singapore 싱가포르" },
    { tz: "Asia/Taipei", name: "Taipei", alias: "taipei taiwan 타이베이 대만" },
    ...
    { tz: "Australia/Perth", name: "Perth", alias: "perth australia 퍼스 호주" },
    { tz: "Australia/Adelaide", name: "Adelaide", alias: "adelaide australia 애들레이드 호주" },
    { tz: "Australia/Brisbane", name: "Brisbane", alias: "brisbane australia 브리즈번 호주" },
    { tz: "Australia/Melbourne", name: "Melbourne", alias: "melbourne australia 멜버른 호주" },
