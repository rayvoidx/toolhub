...
(function tool() {
  ...
  var fx = function (n, d) { return n.toLocaleString(undefined, { minimumFractionDigits: d, maximumFractionDigits: d }); };
  ...
  function calc() {
    ...
    // 영국 갤런(4.546L)은 미국 갤런(3.785L)보다 크므로 같은 차도 수치가 높게 나온다.
    $("r-mpgimp").textContent = fx(mpg * 1.201, 1);
    $("r-l100").textContent = fx(235.215 / mpg, 2);
